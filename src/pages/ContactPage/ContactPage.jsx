    ...
    <div className={styles.contactPage}>
      <div className={styles.contactPageContent}>
        ...
        <div className={styles.contactDescriptionContainer}>
          <h3 className={styles.contactDescriptionTitle}>
            Let's get connected!
          </h3>
          <p className={styles.contactDescription}>
            Looking for a dedicated worker? Or do you simply have a question for
            me?
            <br />
            Feel free to reach out in whichever way you prefer, as long as it's
            listed below!
            <br />
            If you call and I don't pick up, be sure to leave a voicemail and
        ...
        <div className={styles.contactInfoContainer}>
          <div className={styles.contactInfoClassic}>
            <h3 className={styles.contactInfoTitle}>
              Classic contact information
            </h3>
            <p className={styles.contactInfoEmail}>
              Email:{" "}
              <a href="mailto:cs.media.work@outlook.com">
                cs.media.work@outlook.com
              </a>
            </p>
          ...
          <div className={styles.socialMediaContainer}>
            ...
            <div className={styles.socialMediaLinks}>
              <a
                href="https://www.linkedin.com/in/cecilie-schmidt-90a040428/"
                target="_blank"
              ...
              <a
                href="https://github.com/CilleMDU"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
        ...
        <div className={styles.contactFormContainer}>
          ...
          <form className={styles.contactForm} onSubmit={handleSubmit}>
            ...
            {status === "success" && (
              <p className={styles.contactFormStatusSuccess}>
                Message received! Sending good vibes back soon!
              </p>
            )}
            {status === "error" && (
              <p className={styles.contactFormStatusError}>
                Darn it! Something went wrong! Try again or feel free to email
                me directly
              </p>
            )}
          </form>
