...
export default function Navbar() {
  ...
  const getLinkImage = (linkName, linkPath, inactiveImg, activeImg) => {
    return hoveredLink === linkName || isLinkActive(linkPath)
      ? activeImg
      : inactiveImg;
  };
  ...
  return (
    <header className={styles.header} ref={headerRef}>
      ...
      <div className={styles.navbar}>
        ...
        >
          <img
            src={getLinkImage("home", "/", Home, HomeActive)}
            alt="Home page"
        ...
        >
          <img
            src={getLinkImage("process", "/process", BTS, BTSActive)}
            alt="Process page"
        ...
        >
          <img
            src={getLinkImage("about", "/about", About, AboutActive)}
            alt="About page"
